...
public class TermsAndConditionsAdapter extends BaseExpandableListAdapter {
    List<String> list;
    Map<String,List<String>> map;

    public TermsAndConditionsAdapter(List<String> list, Map<String, List<String>> map) {
        this.list = list;
        this.map = map;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            LayoutInflater inflater=LayoutInflater.from(parent.getContext());
            convertView=inflater.inflate(R.layout.terms_list_child,parent,false);
        }
